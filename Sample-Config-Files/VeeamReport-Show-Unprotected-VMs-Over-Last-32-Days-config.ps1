...
$reportMode = 770
# Report Title
$rptTitle = "VeeamReport-Show-Unprotected-VMs-Over-Last-32-Days"
...
$pathHTML = ".\Reports\VeeamReport-Show-Unprotected-VMs-Over-Last-32-Days_$(Get-Date -format yyyyMMdd_HHmmss).htm"
...
$baseFilenameCSV = ".\VeeamReport-Show-Unprotected-VMs-Over-Last-32-Days_$(Get-Date -format yyyyMMdd_HHmmss)"
